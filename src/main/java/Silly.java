...
public class Silly implements Comparable<Silly>{
     ...
     *
     * @param firstname the first name of this Silly instance.
     * @param lastname the last name of this Silly instance.
     */
    ...
    public static void main(String[] args) {
         ...
         */
        x.countStatic(); // was 0, became 1
        y.countStatic(); // was 1, became 2
        x.countStatic(); // was 2, became 3
        x.countStatic(); // was 3, became 4
